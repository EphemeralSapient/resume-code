                  ...
                  children: [
                    Center(
                      child: const Padding(
                        ...
                        child: CircleAvatar(
                          radius:
                              80.0, // Adjust the radius as needed for a bigger profile picture
                    ...
                    ContactInfo(
                        icon: FontAwesome.github, text: "Ephemeral-Sapient"),
                    ContactInfo(
                        icon: FontAwesome.linkedin, text: "Ilavarasan Sampath"),
                    const SizedBox(height: 20.0),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20.0),
                      child: Column(
    ...
    return Container(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: Colors.white,
          fontWeight: FontWeight.bold,
          fontFamily: 'Roboto', // Optionally, you can use a custom font here
        ),
      ),
    );
  }
